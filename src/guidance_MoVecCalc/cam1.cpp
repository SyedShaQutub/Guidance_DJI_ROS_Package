...
int my_callback(int data_type, int data_len, char *content)
{
    ...
    if (e_image == data_type && NULL != content)
    {
		...
		if ( data->m_greyscale_image_left[CAMERA_ID] ){
			...
			left_8.header.frame_id  = "guidance/1/left";
		...
		if ( data->m_greyscale_image_right[CAMERA_ID] ){
			...
			right_8.header.frame_id  = "guidance/1/right";
    ...
    if ( e_obstacle_distance == data_type && NULL != content )
    {
		...
		g_oa.header.frame_id = "guidance/1/obstacle";
    ...
    if ( e_ultrasonic == data_type && NULL != content )
    {
		...
		g_ul.header.frame_id = "guidance/1/ultrasonic";
...
int main(int argc, char** argv)
{
    ...
    left_image_pub			= my_node.advertise<sensor_msgs::Image>("/guidance/1/left_image",1);
    right_image_pub			= my_node.advertise<sensor_msgs::Image>("/guidance/1/right_image",1);
    obstacle_distance_pub	= my_node.advertise<sensor_msgs::LaserScan>("/guidance/1/obstacle_distance",1);
    ultrasonic_pub			= my_node.advertise<sensor_msgs::LaserScan>("/guidance/1/ultrasonic",1);
